...
def main():
    ...
    ax1.grid(True)
    ax1.legend(loc=0)
    ax2.set_title('Train Accuacy')
    ax2.plot(Accu, label='Train Accuracy', c='green')
    ax2.grid(True)
    plt.legend(loc=0)
    plt.savefig('/content/figure.jpg')
...
class Solver(object):
    ...
    def train(self):
        ...
        for batch_num, (data, target) in enumerate(self.train_loader):
            ...
            Cost.append(train_loss / (batch_num + 1))
            Accu.append(train_correct / total)
